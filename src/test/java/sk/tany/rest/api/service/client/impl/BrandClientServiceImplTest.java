...
class BrandClientServiceImplTest {
    ...
    void findAll_returnsOnlyBrandsWithActiveProducts() {
        ...
        when(productRepository.existsByBrandIdAndActiveTrue("id1")).thenReturn(true);
        when(productRepository.existsByBrandIdAndActiveTrue("id2")).thenReturn(false);
        ...
        verify(productRepository).existsByBrandIdAndActiveTrue("id1");
        verify(productRepository).existsByBrandIdAndActiveTrue("id2");

...
public class CartClientRemoveItemValidator implements ConstraintValidator<CartClientRemoveItemConstraint, CartClientRemoveItemRequest> {

    private static final Pattern ID_PATTERN = Pattern.compile("^[a-fA-F0-9]{24}$");
    private final HtmlSanitizerService htmlSanitizerService;

    @Override
    public boolean isValid(CartClientRemoveItemRequest request, ConstraintValidatorContext context) {
        if (request == null) {
            return true;
        }

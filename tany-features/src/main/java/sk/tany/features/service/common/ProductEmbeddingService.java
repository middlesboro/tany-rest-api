package sk.tany.features.service.common;
...
import sk.tany.features.dto.ProductClientDto;
...
public class ProductEmbeddingService {
    ...
    private final sk.tany.features.config.MongoDbConfigProperties mongoDbConfigProperties;
    ...
    public void reEmbedAllProducts() {
        ...
        try {
            ...
            for (Product product : products) {
                if (Boolean.TRUE.equals(product.getActive()) && product.getTitle() != null) {
                    addInternal(product);
                    count++;
                }
            }

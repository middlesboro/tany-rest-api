...
import sk.tany.features.domain.carrier.Carrier;
import sk.tany.features.domain.carrier.CarrierRepository;
import sk.tany.features.domain.customer.Customer;
import sk.tany.features.domain.customer.CustomerRepository;
import sk.tany.features.domain.order.Order;
import sk.tany.features.domain.order.OrderRepository;
import sk.tany.features.domain.payment.Payment;
import sk.tany.features.domain.payment.PaymentRepository;
import sk.tany.features.domain.product.Product;
import sk.tany.features.domain.product.ProductRepository;
import sk.tany.features.domain.shopsettings.ShopSettings;
import sk.tany.features.domain.shopsettings.ShopSettingsRepository;
import sk.tany.features.dto.PriceItem;
import sk.tany.features.dto.PriceItemType;
import sk.tany.features.exception.InvoiceException;
import sk.tany.features.exception.OrderException;
...
public class InvoiceServiceImpl implements InvoiceService {
    ...
    private void addContent(Document document, Order order, Map<String, Product> productMap, boolean isCreditNote) throws DocumentException {
        ...
        if (!isCreditNote && order.getStatus() == sk.tany.features.domain.order.OrderStatus.PAID) {
